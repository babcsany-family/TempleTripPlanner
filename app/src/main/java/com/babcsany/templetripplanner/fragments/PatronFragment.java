...
public class PatronFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (patronPosition >= 0) {
            ...
            TextInputEditText patronNameEditText = (TextInputEditText) getActivity().findViewById(R.id.name_textInput);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_add_or_edit_patron, container, false);
    }
